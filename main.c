...
float gyro_x_measu[row_2] = { 0,0 };			//previous,present
float gyro_y_measu[row_2] = { 0,0 };
float gyro_z_measu[row_2] = { 0,0 };
...
float acc_x_measu[row_2] = { 0,0 };			//previous,present
float acc_y_measu[row_2] = { 0,0 };
float acc_z_measu[row_2] = { 0,0 };

float alt_z_measu[row_2] = { 0,0 };
